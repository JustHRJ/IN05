...
public class csLoginManagedBean implements Serializable {
    ...
    public String login() {
        ...
        if (this.user.equals("Customer")) {
            ...
            try {
                if (this.password.equals(customerSessionBean.decryptPassword(getCustomer().getPw()))) {
...
/**
    public void sendPassword() {
        ...
        String from = "jitcheong@hotmail.com";
        ...
        try {
            ...
            message.setSubject("HiYew - Password Retrieval");

            // Send the actual HTML message, as big as you like
            message.setContent("<h1>Password Retrieval</h1><p>You are receiving this email because you requested a password for your account.</p>"
                    + "</br><p>Your password: " + customerSessionBean.decryptPassword(customer.getPw()) + "</p>", "text/html");

            // Send message
            Transport.send(message);
            System.out.println("Sent message successfully....");
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Password successfully sent!"));
